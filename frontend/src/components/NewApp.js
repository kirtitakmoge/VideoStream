        ...
        <div className="flex">
          ...
          <div className="w-full content flex flex-col">
            ...
            <Routes>
              ...
              <Route path="/profileupdate" element={isLoggedIn ?<ProfileUpdate />:<Navigate to="/login"/>} />
              <Route path="/signout" element={<SignOut />} />
              <Route path="/registration" element={<RegistrationPage />} />
              <Route path="/showvideo" element={isLoggedIn ?<ShowVideo />:<Navigate to="/login"/>} />
              <Route path="/subscriptionPlan" element={isLoggedIn ?<SubscriptionPlanPage />:<Navigate to="/login"/>} />
              <Route path="/subscription/:id" element={isLoggedIn ?<SubscriptionDetailsPage />:<Navigate to="/login"/>} />
              <Route path="/hospitalRegistration" element={isLoggedIn ?<HospitalRegistrationForm />:<Navigate to="/login"/>} />
              <Route path="/surgeonDashboard/:departmentId" element={isLoggedIn ?<SurgeonDashBoard/>:<Navigate to="/login"/>} />
              <Route path="/surgeonList/:departmentId" element={isLoggedIn ?<SurgeonList />:<Navigate to="/login"/>} />
              <Route path='/cameralist/:departmentId' element={isLoggedIn ?<CameraList />:<Navigate to="/login"/>} />
              <Route path="/deviceList/:departmentId" element={isLoggedIn ?<DeviceList />:<Navigate to="/login"/>} />
              <Route path="/deviceListadmin/:departmentId" element={isLoggedIn ?<DeviceListAdmin />:<Navigate to="/login"/>} />
              <Route path="/department-details/:departmentId" element={isLoggedIn ?<DepartmentDetails />:<Navigate to="/login"/>} />
              <Route path='/showvideo/:departmentId' element={isLoggedIn ?<ShowVideo />:<Navigate to="/login"/>} />
              <Route path="/createCamera/:departmentId" element={isLoggedIn ?<CameraForm />:<Navigate to="/login"/>}/>
              

              <Route path="/hospitalAdmin/:hospitalId" element={isLoggedIn ? <HospitalAdmin />:<Navigate to="/login"/>} />
