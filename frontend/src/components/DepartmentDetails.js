    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 m">
        <div className="col-span-1 shadow-md">
          ...
          <Link to={`/surgeonList/${departmentId}`} className="button h-full bg-gray-200 p-4 rounded-md block hover:bg-gray-300">
            <h2 className="text-xl text-center font-bold mb-4">Surgeons</h2>
          </Link>
        </div>
        <div className="col-span-1 shadow-md">
          {/* Style the link to resemble a button */}
          <Link to={`/cameraList/${departmentId}`} className="button h-full bg-gray-200 p-4 rounded-md block hover:bg-gray-300">
            <h2 className="text-xl text-center font-bold mb-4">Live stream from camera</h2>
          </Link>
        </div>
        <div className="col-span-1  shadow-md ">
          <Link to={`/devicelist/${departmentId}`} className="button h-full bg-gray-200 p-4 rounded-md block hover:bg-gray-300">
            <h2 className="text-xl text-center font-bold mb-4">Recorded Video from camera</h2>
            
          </Link>
        </div>
        <div className="col-span-1 shadow-md">
          <Link to={`/createCamera/${departmentId}/${department_name}`} className="button h-full bg-gray-200 p-4 rounded-md block hover:bg-gray-300">
            <h2 className="text-xl text-center font-bold mb-4">Add new Camera</h2>
          </Link>
        </div>
        <div className="col-span-1 shadow-md">
          <Link to={`/patientData/${departmentId}`}className="button h-full bg-gray-200 p-4 rounded-md block hover:bg-gray-300">
            <h2 className="text-xl text-center font-bold mb-4">Patients</h2>
          </Link>
        </div>
        <div className="col-span-1 shadow-md">
          {/* Button to show delete modal */}
          <button onClick={() => setShowDeleteModal(true)} className="button h-full bg-gray-200 p-4 rounded-md block hover:bg-gray-200 w-full">
            <h2 className="text-xl  text-center font-bold mb-4">Remove Department</h2>
          </button>
        </div>
        <div className="col-span-1 shadow-md">
          {/* Button to show rename modal */}
          <button onClick={() => setShowRenameModal(true)} className="button h-full bg-gray-200 p-4 rounded-md block hover:bg-gray-200 w-full">
          <h2 className="text-xl text-center font-bold mb-4">Rename Department</h2>
          </button>
        </div>
      </div>
