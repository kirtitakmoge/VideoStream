    ...
    <div className="container mx-auto px-4 py-4 relative">
      ...
      <div className="grid grid-cols-3 gap-8">
        <div className="col-span-1 shadow-md">
          ...
          <Link to={`/surgeonListOnly/${departmentId}`} className="button bg-gray-100 p-4 rounded-md block hover:bg-gray-200 w-full">
        ...
        <div className="col-span-1  shadow-md ">
          <Link to={`/devicelist/${departmentId}`} className="bg-gray-100 p-4 rounded-md block hover:bg-gray-200">
            <h2 className="text-2xl font-bold mb-4">Recorded Video from camera</h2>
            
          </Link>
        </div>
        <div className="col-span-1  shadow-md ">
          <Link to={`/patientData/${departmentId}`} className="bg-gray-100 p-4 rounded-md block hover:bg-gray-200">
        ...
        <div className="col-span-1  shadow-md ">
          <Link to={`/createCamera/${departmentId}/${department_name}`} className="bg-gray-100 p-4 rounded-md block hover:bg-gray-200">
